...
public class XboxControllerMapperOSX : AControlsMapper {

	// Key, Value
	private Dictionary<InputKeyValue, string> _controls;
	private string _systemType = "OSX";

	public XboxControllerMapperOSX (PlayerNumber playerNumber) {
	...
	public override bool AimingRight () {
		return Input.GetAxisRaw(GetAimHorizontalAxis()) > 0.4f;
	}
